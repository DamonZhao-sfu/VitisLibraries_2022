...
void get_cfg_dat_JOIN_INNER_TD_7792_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 6; // n_nationkey#144
    shuffle2_cfg(15, 8) = -1;
    ...
    shuffle3_cfg(7, 0) = 0; // n_nationkey#144
    shuffle3_cfg(15, 8) = -1;
    ...
    shuffle4_cfg(7, 0) = 0; // n_nationkey#144
    shuffle4_cfg(15, 8) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_7792_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_INNER_TD_8292_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 11; // s_suppkey#342
    shuffle2_cfg(15, 8) = -1;
    shuffle2_cfg(23, 16) = -1;
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // s_suppkey#342
    shuffle3_cfg(15, 8) = -1;
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // s_suppkey#342
    shuffle4_cfg(15, 8) = -1;
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_8292_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;

    // input table a
    signed char id_a[] = {3,5,2,4,6,1,0,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(56 + 8 * c + 7, 56 + 8 * c) = id_a[c];
    }
    // filter tbl_a config
...
void get_cfg_dat_JOIN_INNER_TD_956_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 0; // ps_partkey#305
    shuffle2_cfg(15, 8) = 1; // ps_supplycost#308
    shuffle2_cfg(23, 16) = 12; // ps_suppkey#306
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    ...
    shuffle3_cfg(15, 8) = 1; // ps_supplycost#308
    shuffle3_cfg(23, 16) = 2; // ps_suppkey#306
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    ...
    shuffle4_cfg(15, 8) = 1; // ps_supplycost#308
    shuffle4_cfg(23, 16) = 2; // ps_suppkey#306
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_956_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    // input table b
    signed char id_b[] = {1,0,2,-1,-1,-1,-1,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(120 + 8 * c + 7, 120 + 8 * c) = id_b[c];
    }
    // filter tbl_b config
...
void get_cfg_dat_JOIN_INNER_TD_5695_gqe_join(ap_uint<512>* hbuf) {
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 12; // p_partkey#258
    shuffle2_cfg(15, 8) = 0; // p_mfgr#260
    shuffle2_cfg(23, 16) = 6; // ps_suppkey#306
    shuffle2_cfg(31, 24) = 7; // ps_supplycost#308
    shuffle2_cfg(39, 32) = 12; // ps_partkey#305
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // p_partkey#258
    shuffle3_cfg(15, 8) = 1; // p_mfgr#260
    shuffle3_cfg(23, 16) = 2; // ps_suppkey#306
    shuffle3_cfg(31, 24) = 3; // ps_supplycost#308
    shuffle3_cfg(39, 32) = 4; // ps_partkey#305
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // p_partkey#258
    shuffle4_cfg(15, 8) = 1; // p_mfgr#260
    shuffle4_cfg(23, 16) = 2; // ps_suppkey#306
    shuffle4_cfg(31, 24) = 3; // ps_supplycost#308
    shuffle4_cfg(39, 32) = 4; // ps_partkey#305
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
    shuffle4_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_5695_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_INNER_TD_4192_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: true StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 13; // p_partkey#258
    shuffle2_cfg(15, 8) = 0; // p_mfgr#260
    shuffle2_cfg(23, 16) = 2; // ps_suppkey#306
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_4192_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    // input table b
    signed char id_b[] = {3,0,1,4,2,-1,-1,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(120 + 8 * c + 7, 120 + 8 * c) = id_b[c];
    }
    // filter tbl_b config
...
void get_cfg_dat_JOIN_INNER_TD_3872_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: true StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((s_suppkey#342 = ps_suppkey#306))
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 7; // p_partkey#258
    shuffle2_cfg(15, 8) = 6; // p_mfgr#260
    shuffle2_cfg(23, 16) = 4; // s_name#343
    shuffle2_cfg(31, 24) = 1; // s_address#344
    shuffle2_cfg(39, 32) = 5; // s_nationkey#345
    shuffle2_cfg(47, 40) = 2; // s_phone#346
    shuffle2_cfg(55, 48) = 0; // s_acctbal#347
    shuffle2_cfg(63, 56) = 3; // s_comment#348
    ...
    shuffle3_cfg(7, 0) = 0; // p_partkey#258
    shuffle3_cfg(15, 8) = 1; // p_mfgr#260
    shuffle3_cfg(23, 16) = 2; // s_name#343
    shuffle3_cfg(31, 24) = 3; // s_address#344
    shuffle3_cfg(39, 32) = 4; // s_nationkey#345
    shuffle3_cfg(47, 40) = 5; // s_phone#346
    shuffle3_cfg(55, 48) = 6; // s_acctbal#347
    shuffle3_cfg(63, 56) = 7; // s_comment#348
    ...
    shuffle4_cfg(7, 0) = 0; // p_partkey#258
    shuffle4_cfg(15, 8) = 1; // p_mfgr#260
    shuffle4_cfg(23, 16) = 2; // s_name#343
    shuffle4_cfg(31, 24) = 3; // s_address#344
    shuffle4_cfg(39, 32) = 4; // s_nationkey#345
    shuffle4_cfg(47, 40) = 5; // s_phone#346
    shuffle4_cfg(55, 48) = 6; // s_acctbal#347
    shuffle4_cfg(63, 56) = 7; // s_comment#348
...
void get_cfg_dat_JOIN_INNER_TD_3872_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    // input table b
    signed char id_b[] = {0,5,2,4,6,1,3,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(120 + 8 * c + 7, 120 + 8 * c) = id_b[c];
    }
    // filter tbl_b config
