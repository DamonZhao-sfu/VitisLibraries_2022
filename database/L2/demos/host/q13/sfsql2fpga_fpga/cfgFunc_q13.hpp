...
void get_cfg_dat_JOIN_INNER_TD_0301_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(15, 8) = 0; // o_orderkey#207
    shuffle2_cfg(23, 16) = 12; // o_custkey#208
    ...
    shuffle3_cfg(15, 8) = 1; // o_orderkey#207
    shuffle3_cfg(23, 16) = 2; // o_custkey#208
    ...
    shuffle4_cfg(15, 8) = 1; // o_orderkey#207
    shuffle4_cfg(23, 16) = 2; // o_custkey#208
...
void get_cfg_dat_JOIN_INNER_TD_0301_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_LEFTANTI_TD_3852_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    ...
    shuffle2_cfg(15, 8) = 1; // o_orderkey#207
...
void get_cfg_dat_JOIN_LEFTANTI_TD_3852_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
