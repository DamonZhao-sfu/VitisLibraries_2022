...
void get_cfg_dat_JOIN_INNER_TD_7773_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 6; // s_nationkey#345
    shuffle2_cfg(15, 8) = 3; // l_orderkey#77
    shuffle2_cfg(23, 16) = 1; // l_extendedprice#82
    shuffle2_cfg(31, 24) = 0; // l_discount#83
    shuffle2_cfg(39, 32) = 2; // l_shipdate#87
    ...
    shuffle3_cfg(7, 0) = 0; // s_nationkey#345
    shuffle3_cfg(15, 8) = 1; // l_orderkey#77
    shuffle3_cfg(23, 16) = 2; // l_extendedprice#82
    shuffle3_cfg(31, 24) = 3; // l_discount#83
    shuffle3_cfg(39, 32) = 4; // l_shipdate#87
    ...
    shuffle4_cfg(7, 0) = 0; // s_nationkey#345
    shuffle4_cfg(15, 8) = 1; // l_orderkey#77
    shuffle4_cfg(23, 16) = 2; // l_extendedprice#82
    shuffle4_cfg(31, 24) = 3; // l_discount#83
    shuffle4_cfg(39, 32) = 4; // l_shipdate#87
...
void get_cfg_dat_JOIN_INNER_TD_7773_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    // input table b
    signed char id_b[] = {1,3,2,4,0,-1,-1,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(120 + 8 * c + 7, 120 + 8 * c) = id_b[c];
    }
    // filter tbl_b config
...
void get_cfg_dat_JOIN_INNER_TD_6771_gqe_join(ap_uint<512>* hbuf) {
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 1; // l_extendedprice#82
    shuffle2_cfg(15, 8) = 0; // l_discount#83
    shuffle2_cfg(23, 16) = 2; // l_shipdate#87
    shuffle2_cfg(31, 24) = 6; // n_name#145
    shuffle2_cfg(39, 32) = 12; // s_nationkey#345
    shuffle2_cfg(47, 40) = 3; // l_orderkey#77
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // l_extendedprice#82
    shuffle3_cfg(15, 8) = 1; // l_discount#83
    shuffle3_cfg(23, 16) = 2; // l_shipdate#87
    shuffle3_cfg(31, 24) = 3; // n_name#145
    shuffle3_cfg(39, 32) = 4; // s_nationkey#345
    shuffle3_cfg(47, 40) = 5; // l_orderkey#77
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // l_extendedprice#82
    shuffle4_cfg(15, 8) = 1; // l_discount#83
    shuffle4_cfg(23, 16) = 2; // l_shipdate#87
    shuffle4_cfg(31, 24) = 3; // n_name#145
    shuffle4_cfg(39, 32) = 4; // s_nationkey#345
    shuffle4_cfg(47, 40) = 5; // l_orderkey#77
    shuffle4_cfg(55, 48) = -1;
    shuffle4_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_6771_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    // input table b
    signed char id_b[] = {0,3,2,4,1,-1,-1,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(120 + 8 * c + 7, 120 + 8 * c) = id_b[c];
    }
    // filter tbl_b config
...
void get_cfg_dat_JOIN_INNER_TD_5573_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: true StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 10; // s_nationkey#345
    shuffle2_cfg(15, 8) = 7; // l_extendedprice#82
    shuffle2_cfg(23, 16) = 6; // l_discount#83
    shuffle2_cfg(31, 24) = 8; // l_shipdate#87
    shuffle2_cfg(39, 32) = 0; // o_custkey#208
    shuffle2_cfg(47, 40) = 9; // n_name#145
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // s_nationkey#345
    shuffle3_cfg(15, 8) = 1; // l_extendedprice#82
    shuffle3_cfg(23, 16) = 2; // l_discount#83
    shuffle3_cfg(31, 24) = 3; // l_shipdate#87
    shuffle3_cfg(39, 32) = 4; // o_custkey#208
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // s_nationkey#345
    shuffle4_cfg(15, 8) = 1; // l_extendedprice#82
    shuffle4_cfg(23, 16) = 2; // l_discount#83
    shuffle4_cfg(31, 24) = 3; // l_shipdate#87
    shuffle4_cfg(39, 32) = 4; // o_custkey#208
...
void get_cfg_dat_JOIN_INNER_TD_5573_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;

    // input table a
    signed char id_a[] = {5,1,0,2,3,4,-1,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(56 + 8 * c + 7, 56 + 8 * c) = id_a[c];
    }
    // filter tbl_a config
...
void get_cfg_dat_JOIN_INNER_TD_4852_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: true StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    shuffle2_cfg(15, 8) = 0; // l_discount#83
    shuffle2_cfg(23, 16) = 2; // l_shipdate#87
    shuffle2_cfg(31, 24) = 6; // c_nationkey#25
    shuffle2_cfg(39, 32) = 3; // n_name#145
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    shuffle3_cfg(15, 8) = 1; // l_discount#83
    shuffle3_cfg(23, 16) = 2; // l_shipdate#87
    shuffle3_cfg(31, 24) = 3; // c_nationkey#25
    shuffle3_cfg(39, 32) = 4; // n_name#145
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    shuffle4_cfg(15, 8) = 1; // l_discount#83
    shuffle4_cfg(23, 16) = 2; // l_shipdate#87
    shuffle4_cfg(31, 24) = 3; // c_nationkey#25
    shuffle4_cfg(39, 32) = 4; // n_name#145
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
    shuffle4_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_4852_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    // input table b
    signed char id_b[] = {4,2,1,3,5,0,-1,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(120 + 8 * c + 7, 120 + 8 * c) = id_b[c];
    }
    // filter tbl_b config
