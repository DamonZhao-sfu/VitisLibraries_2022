...
void get_cfg_dat_Aggregate_TD_6900_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(l_orderkey#77, sum(l_quantity#81) AS sum(l_quantity#81)#1717L)
    // Input Table: ListBuffer(l_orderkey#77, l_quantity#81)
    // Output Table: ListBuffer(l_orderkey#77, sum(l_quantity#81)#1717L)
    // Node Depth: 6
    ...
    shuffle1_cfg(7, 0) = 0; // l_orderkey#77
    shuffle1_cfg(15, 8) = 1; // l_quantity#81
    ...
    shuffle2_cfg(7, 0) = 0; // l_orderkey#77
    shuffle2_cfg(15, 8) = 1; // l_quantity#81
    ...
    shuffle3_cfg(7, 0) = 0; // l_orderkey#77
    shuffle3_cfg(15, 8) = -1;
    ...
    shuffle4_cfg(7, 0) = 1; // sum(l_quantity#81)#1717L
    shuffle4_cfg(15, 8) = -1;
...
void get_cfg_dat_Aggregate_TD_6900_gqe_aggr_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_4183_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 12; // o_orderkey#207
    shuffle2_cfg(15, 8) = 0; // o_custkey#208
    shuffle2_cfg(23, 16) = 2; // o_totalprice#210
    shuffle2_cfg(31, 24) = 1; // o_orderdate#211
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // o_orderkey#207
    shuffle3_cfg(15, 8) = 1; // o_custkey#208
    shuffle3_cfg(23, 16) = 2; // o_totalprice#210
    shuffle3_cfg(31, 24) = 3; // o_orderdate#211
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // o_orderkey#207
    shuffle4_cfg(15, 8) = 1; // o_custkey#208
    shuffle4_cfg(23, 16) = 2; // o_totalprice#210
    shuffle4_cfg(31, 24) = 3; // o_orderdate#211
    shuffle4_cfg(39, 32) = -1;
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
    shuffle4_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_4183_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_342_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTSEMI
    // Operation: ListBuffer((l_orderkey#77 = l_orderkey#77#1794))
    // Left Table: ListBuffer(l_orderkey#77#1794)
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 12; // l_orderkey#77
    shuffle2_cfg(15, 8) = 0; // l_quantity#81
    shuffle2_cfg(23, 16) = -1;
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    ...
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // l_orderkey#77
    shuffle3_cfg(15, 8) = 1; // l_quantity#81
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // l_orderkey#77
    shuffle4_cfg(15, 8) = 1; // l_quantity#81
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
    shuffle4_cfg(47, 40) = -1;
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_342_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_INNER_TD_3777_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(15, 8) = 6; // c_name#23
    shuffle2_cfg(23, 16) = 2; // o_orderkey#207
    shuffle2_cfg(31, 24) = 1; // o_totalprice#210
    shuffle2_cfg(39, 32) = 0; // o_orderdate#211
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    shuffle3_cfg(23, 16) = 2; // o_orderkey#207
    shuffle3_cfg(31, 24) = 3; // o_totalprice#210
    shuffle3_cfg(39, 32) = 4; // o_orderdate#211
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    shuffle4_cfg(23, 16) = 2; // o_orderkey#207
    shuffle4_cfg(31, 24) = 3; // o_totalprice#210
    shuffle4_cfg(39, 32) = 4; // o_orderdate#211
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
    shuffle4_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_3777_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    // input table b
    signed char id_b[] = {1,3,2,0,-1,-1,-1,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(120 + 8 * c + 7, 120 + 8 * c) = id_b[c];
    }
    // filter tbl_b config
...
void get_cfg_dat_JOIN_INNER_TD_2234_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: true StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((o_orderkey#207 = l_orderkey#77))
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 8; // c_custkey#22
    shuffle2_cfg(15, 8) = 9; // c_name#23
    shuffle2_cfg(23, 16) = 12; // o_orderkey#207
    shuffle2_cfg(31, 24) = 7; // o_totalprice#210
    shuffle2_cfg(39, 32) = 6; // o_orderdate#211
    shuffle2_cfg(47, 40) = 0; // l_quantity#81
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    shuffle3_cfg(31, 24) = 3; // o_totalprice#210
    shuffle3_cfg(39, 32) = 4; // o_orderdate#211
    shuffle3_cfg(47, 40) = 5; // l_quantity#81
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    shuffle4_cfg(31, 24) = 3; // o_totalprice#210
    shuffle4_cfg(39, 32) = 4; // o_orderdate#211
    shuffle4_cfg(47, 40) = 5; // l_quantity#81
    shuffle4_cfg(55, 48) = -1;
    shuffle4_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_2234_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;

    // input table a
    signed char id_a[] = {2,4,3,0,1,-1,-1,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(56 + 8 * c + 7, 56 + 8 * c) = id_a[c];
    }
    // filter tbl_a config
