...
void get_cfg_dat_JOIN_INNER_TD_3451_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 2; // o_orderkey#207
    shuffle2_cfg(15, 8) = 0; // o_orderdate#211
    shuffle2_cfg(23, 16) = 1; // o_shippriority#214
    ...
    shuffle3_cfg(15, 8) = 1; // o_orderdate#211
    shuffle3_cfg(23, 16) = 2; // o_shippriority#214
    ...
    shuffle4_cfg(15, 8) = 1; // o_orderdate#211
    shuffle4_cfg(23, 16) = 2; // o_shippriority#214
...
void get_cfg_dat_JOIN_INNER_TD_3451_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    // input table b
    signed char id_b[] = {1,2,3,0,-1,-1,-1,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(120 + 8 * c + 7, 120 + 8 * c) = id_b[c];
    }
    // filter tbl_b config
...
void get_cfg_dat_JOIN_INNER_TD_2156_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_JOIN_INNER_TD_2156_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_Aggregate_TD_1746_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
...
void get_cfg_dat_Aggregate_TD_1746_gqe_aggr_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;

    // input table a
    signed char id_a[] = {2,3,4,5,-1,-1,-1,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(56 + 8 * c + 7, 56 + 8 * c) = id_a[c];
    }
    // filter tbl_a config
