...
void get_cfg_dat_JOIN_LEFTANTI_TD_3443_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 0; // c_phone#26
    shuffle2_cfg(15, 8) = 1; // c_acctbal#27
    ...
    shuffle3_cfg(7, 0) = 0; // c_phone#26
    shuffle3_cfg(15, 8) = 1; // c_acctbal#27
    ...
    shuffle4_cfg(7, 0) = 0; // c_phone#26
    shuffle4_cfg(15, 8) = 1; // c_acctbal#27
...
void get_cfg_dat_JOIN_LEFTANTI_TD_3443_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
