...
void get_cfg_dat_JOIN_LEFTANTI_TD_3594_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(15, 8) = 12; // ps_suppkey#306
...
void get_cfg_dat_JOIN_LEFTANTI_TD_3594_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_INNER_TD_2502_gqe_join(ap_uint<512>* hbuf) {
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 0; // ps_suppkey#306
    shuffle2_cfg(15, 8) = 7; // p_brand#261
    shuffle2_cfg(23, 16) = 8; // p_type#262
    shuffle2_cfg(31, 24) = 6; // p_size#263
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    shuffle3_cfg(15, 8) = 1; // p_brand#261
    shuffle3_cfg(23, 16) = 2; // p_type#262
    shuffle3_cfg(31, 24) = 3; // p_size#263
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    shuffle4_cfg(15, 8) = 1; // p_brand#261
    shuffle4_cfg(23, 16) = 2; // p_type#262
    shuffle4_cfg(31, 24) = 3; // p_size#263
    shuffle4_cfg(39, 32) = -1;
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
    shuffle4_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_2502_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
