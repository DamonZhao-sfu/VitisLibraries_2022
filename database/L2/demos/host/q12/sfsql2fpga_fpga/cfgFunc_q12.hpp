...
void get_cfg_dat_JOIN_INNER_TD_2161_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 0; // o_orderpriority#212
    shuffle2_cfg(15, 8) = 6; // l_shipmode#91
    ...
    shuffle3_cfg(7, 0) = 0; // o_orderpriority#212
    shuffle3_cfg(15, 8) = 1; // l_shipmode#91
    ...
    shuffle4_cfg(7, 0) = 0; // o_orderpriority#212
    shuffle4_cfg(15, 8) = 1; // l_shipmode#91
...
void get_cfg_dat_JOIN_INNER_TD_2161_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
