...
void get_cfg_dat_JOIN_INNER_TD_3217_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 0; // s_suppkey#342
    shuffle2_cfg(15, 8) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_3217_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_INNER_TD_4851_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 1; // ps_partkey#305
    shuffle2_cfg(15, 8) = 0; // ps_availqty#307
    shuffle2_cfg(23, 16) = 2; // ps_supplycost#308
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    ...
    shuffle3_cfg(15, 8) = 1; // ps_availqty#307
    shuffle3_cfg(23, 16) = 2; // ps_supplycost#308
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    ...
    shuffle4_cfg(15, 8) = 1; // ps_availqty#307
    shuffle4_cfg(23, 16) = 2; // ps_supplycost#308
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_4851_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
