...
void get_cfg_dat_JOIN_LEFTSEMI_TD_778_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTSEMI
    // Operation: ListBuffer(((l_orderkey#77#2000 = l_orderkey#77) AND NOT (l_suppkey#79#2002 = l_suppkey#79)))
    // Left Table: ListBuffer(l_orderkey#77#2000, l_suppkey#79#2002)
    ...
    shuffle2_cfg(15, 8) = 0; // l_suppkey#79
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_778_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_654_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTSEMI
    // Operation: ListBuffer(((l_orderkey#77#2016 = l_orderkey#77) AND NOT (l_suppkey#79#2018 = l_suppkey#79)))
    // Left Table: ListBuffer(l_orderkey#77#2016, l_suppkey#79#2018)
    // Right Table: ListBuffer(l_orderkey#77, l_suppkey#79)
    // Output Table: ListBuffer(l_orderkey#77, l_suppkey#79)
    // Node Depth: 6
    ap_uint<512>* b = hbuf;
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_654_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_LEFTANTI_TD_5941_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTANTI
    // Operation: ListBuffer(((l_orderkey#77#2016 = l_orderkey#77) AND NOT (l_suppkey#79#2018 = l_suppkey#79)))
    // Left Table: ListBuffer(l_orderkey#77, l_suppkey#79)
    // Right Table: ListBuffer(l_orderkey#77#2016, l_suppkey#79#2018)
    // Output Table: ListBuffer(l_orderkey#77, l_suppkey#79)
    // Node Depth: 5
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ...
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 12; // l_orderkey#77
    shuffle2_cfg(15, 8) = 13; // l_suppkey#79
    shuffle2_cfg(23, 16) = -1;
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
...
void get_cfg_dat_JOIN_LEFTANTI_TD_5941_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_INNER_TD_3311_gqe_join(ap_uint<512>* hbuf) {
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 7; // s_suppkey#342
    shuffle2_cfg(15, 8) = 6; // s_name#343
    shuffle2_cfg(23, 16) = -1;
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    ...
    shuffle3_cfg(15, 8) = 1; // s_name#343
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    ...
    shuffle4_cfg(15, 8) = 1; // s_name#343
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
    shuffle4_cfg(47, 40) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_3311_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_INNER_TD_4400_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: true StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 6; // s_name#343
    shuffle2_cfg(15, 8) = 0; // l_orderkey#77
    shuffle2_cfg(23, 16) = -1;
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_4400_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_INNER_TD_2412_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: true StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_JOIN_INNER_TD_2412_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
