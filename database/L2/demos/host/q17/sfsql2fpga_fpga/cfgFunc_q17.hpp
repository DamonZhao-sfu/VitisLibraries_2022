...
void get_cfg_dat_JOIN_INNER_TD_265_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 0; // l_quantity#81
    shuffle2_cfg(15, 8) = 1; // l_extendedprice#82
    shuffle2_cfg(23, 16) = 12; // p_partkey#258
    ...
    shuffle3_cfg(7, 0) = 0; // l_quantity#81
    shuffle3_cfg(15, 8) = 1; // l_extendedprice#82
    shuffle3_cfg(23, 16) = 2; // p_partkey#258
    ...
    shuffle4_cfg(7, 0) = 0; // l_quantity#81
    shuffle4_cfg(15, 8) = 1; // l_extendedprice#82
    shuffle4_cfg(23, 16) = 2; // p_partkey#258
...
void get_cfg_dat_JOIN_INNER_TD_265_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
