...
void get_cfg_dat_Aggregate_TD_4400_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(l_suppkey#79, sum((l_extendedprice#82 * (1 - l_discount#83))) AS sum((l_extendedprice * (1 - l_discount)))#1461L)
    // Input Table: ListBuffer(l_suppkey#79, l_extendedprice#82, l_discount#83)
    // Output Table: ListBuffer(l_suppkey#79, sum((l_extendedprice * (1 - l_discount)))#1461L)
    // Node Depth: 4
    ...
    shuffle1_cfg(31, 24) = 8; // sum((l_extendedprice * (1 - l_discount)))#1461L
    ...
    shuffle2_cfg(31, 24) = 3; // sum((l_extendedprice * (1 - l_discount)))#1461L
    ...
    shuffle4_cfg(7, 0) = 3; // sum((l_extendedprice * (1 - l_discount)))#1461L
    shuffle4_cfg(15, 8) = -1;
...
void get_cfg_dat_Aggregate_TD_4400_gqe_aggr_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
